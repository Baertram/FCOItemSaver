...
local researchTextureName = ctrlVars.RESEARCH:GetName() .. "_FilterButton%sTexture"
local researchDialogTextureName = ctrlVars.RESEARCH_POPUP_TOP_DIVIDER:GetName() .. "_FilterButton%sTexture"
